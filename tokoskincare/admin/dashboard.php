...
$totalBuktiPending = fetchSingleValue($conn, "SELECT COUNT(*) AS total FROM payments WHERE status_pembayaran = 'pending' AND bukti_transfer IS NOT NULL AND bukti_transfer <> ''");
...
<div class="admin-layout d-flex" style="min-height: 100vh;">
    ...
    <main class="flex-grow-1 p-4">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                <a href="index.php?page=admin-bukti-pembayaran&status=pending" class="text-decoration-none text-dark">
                    <div class="card border-0 shadow-sm p-3 card-hover h-100">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <div class="text-uppercase text-muted fw-semibold small">Bukti Pending</div>
                                <div class="fw-bold fs-2 lh-1"><?= e($totalBuktiPending) ?></div>
