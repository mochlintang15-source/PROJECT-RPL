...
<input type="text" name="telepon" placeholder="08xxxx" required>
...
function pilihMetode(el, metode){
  ...
  if(metode === "Gopay" || metode === "OVO" || metode === "Dana"){
    html = `
      ...
      <input type="text" name="nomor_pembayaran" placeholder="08xxxx" required>
...
let nomor = document.querySelector(
    "input[name='nomor_pembayaran']"
);
